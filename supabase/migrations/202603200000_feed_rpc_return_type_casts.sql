-- Fix: cast enum/uuid columns to text so RETURNS TABLE (condition text, grading_company text, card_ref_id text, language text) matches query result.
-- Resolves "structure of query does not match function result type" from PostgREST.
