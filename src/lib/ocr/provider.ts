            ...
            content: [
              {
                type: "input_text",
                text:
                  "Extract visible Pokemon card information from this photo. Return plain text only with likely card name, card number, set/expansion, language, rarity, and any grading text if visible.",
              },
              {
                type: "input_image",
